...
export default function DocumentDetailManager() {
  const { id } = useParams();
                    ...
                    <div>
                      <div style={{ marginBottom: 8 }}>
                        This document replaces: <strong>{
                          <Link to={`/manager/doc/${mainDoc.replacementDocument.id}`}>
                    ...
                    <div>
                      <div style={{ marginBottom: 8 }}>
                        This document has been replaced by: <strong>
                          <Link to={`/manager/doc/${mainDoc.replacedByDocument.id}`}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                              ...
                              <div style={{ display: 'flex', gap: 8 }}>
                                {/* <Button
                                  size="small"
                                  icon={<EyeOutlined />}
                                  onClick={() => navigate(`/document/${id}/${ver.versionId}`)}
                                >
                                  Preview
                                </Button> */}
                                <Button
