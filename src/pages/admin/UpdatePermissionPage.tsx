...
const UpdatePermissionPage = () => {
  ...
  const onSubmit = (data: UpdatePermissionData) => {
    updatePermissionMutation.mutate(
      { permissionId: permissionId!, data },
      {
        onSuccess: () => {
  ...
  if (isLoading) {
    return (
      <div className="relative z-10 flex-1 overflow-auto">
        <Header title="Update Permission" />
  ...
  if (isError || !permissionData) {
    return (
      <div className="relative z-10 flex-1 overflow-auto">
        <Header title="Update Permission" />
        <div className="flex items-center justify-center h-64">
          <p className="text-red-400">Failed to load permission data</p>
        </div>
      </div>
    );
  }
        ...
        >
          <div className="flex items-center gap-4 mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-100">
              Update Permission: {permissionData.name}
            </h1>
          </div>
