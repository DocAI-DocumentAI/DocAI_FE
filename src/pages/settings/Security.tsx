          ...
          {twoFactorEnabled && (
            <div className="mt-4">
              ...
              <select
                ...
                className="w-full max-w-xs px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
              >
              ...
              <p className="mt-1 text-xs text-gray-500">
                Choose how you want to receive your two-factor authentication
                codes
              </p>
            </div>
          )}
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Receive alerts about security events and important account
                changes
              </p>
            </div>
            <div className="flex items-center">
      ...
      <div className="p-6 bg-white border border-gray-200 rounded-lg">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full max-w-md px-3 py-2 border border-gray-300 rounded-md focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
