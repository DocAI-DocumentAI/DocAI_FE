...
import { useUserAnalytics } from "../../services/userAnalyticsService";

// Format data for chart display
const formatChartData = (data: any[], timeRange: string) => {
...
const UserGrowthChart: React.FC = () => {
  ...
  const chartData = formatChartData(analyticsData || [], timeRange);
  ...
  const getTitle = () => {
    switch (timeRange) {
      ...
      case "weekly":
        return "User Growth (This Week)";
      case "monthly":
        return "User Growth (This Year)";
      default:
        return "User Growth";
    }
  };
      ...
      <div className="h-80">
        <ResponsiveContainer width={"100%"} height={"100%"}>
          <LineChart data={chartData}>
            ...
            {/* Line for Total Users (only for monthly view) */}
            {timeRange === "monthly" && (
              <Line
                type="monotone"
                dataKey="totalUsers"
