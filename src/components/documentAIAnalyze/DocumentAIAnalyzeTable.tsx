import {
  ...
  useSetDefaultDocumentAIAnalyzeConfig,
...
interface DocumentAIAnalyzeTableProps {
  ...
  onDeleteClick: (config: DocumentAIAnalyzeConfig) => void;
}

const DocumentAIAnalyzeTable: React.FC<DocumentAIAnalyzeTableProps> = ({
  configs,
  onDeleteClick,
}) => {
  ...
  const handleSetDefault = (id: string) => {
    setDefaultMutation.mutate(id, {
      onSuccess: () =>
        toast.success("Default AI analyze configuration set successfully"),
      onError: (error) =>
        toast.error(`Error setting default configuration: ${error.message}`),
    });
  };
